...
<!--
показывает, что многозональный OSPF экономит ресурсы, изолируя сбои в области. Сбой в области 51 приводит к обмену LSA и запуску алгоритма SPF, изолированного от области 0 и области 1
-->
