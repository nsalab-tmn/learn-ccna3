...
<!--
На рисунке приведена топология. R1 связан с последовательным соединением с R2. R2 связан с последовательным соединением с R3. R1 имеет канал до S1. S1 имеет канал до  PC1 и S2. S2 имеет канал до SRV2. R3 имеет канал до S3. S3 имеет канал до SRV1.
-->
...
<!--
На рисунке показано использование команд ping и traceroute для устранения неполадок сквозного подключения в сети.  R1 связан с последовательным соединением с R2. R2 связан с последовательным соединением с R3. R1 имеет канал до S1. S1 имеет канал до  PC1 и S2. S2 имеет канал до SRV2. R3 имеет канал до S3. S3 имеет канал до SRV1. На рисунке линия, которая отображает путь от PC1 до SRV1 с помощью инструментов ping и traceroute.
-->
...
<!--
На рисунке показана топология сети с PC1, испытывающая проблемы с производительностью при взаимодействии с SRV2. На рисунке показан S1 с канадом до PC1 и S2. S2 имеет канал до SRV2. Имеются существенные проблемы с производительностью при взаимодействии с SRV2.
-->
...
<!--
На рисунке показано, как PC1 использует R1 в качестве шлюза по умолчанию, а R1 использует R2 в качестве шлюза последней инстанции. R1 связан с последовательным соединением с R2. R2 связан с последовательным соединением с R3. R1 имеет канал до S1. S1 имеет канал до  PC1 и S2. S2 имеет канал до SRV2. R3 имеет канал до S3. S3 имеет канал до SRV1. PC1 имеет комментарий, Мой шлюз по умолчанию R1 и R1 имеет комментарий, Мой шлюз "последней надежды" - R2.
-->
...
<!--
На рисунке показана типичная топология, на которой указывает путь для передачи пакетов от ПК1 на SRV1. R1 связан с последовательным соединением с R2. R2 связан с последовательным соединением с R3. R1 имеет канал до S1. S1 имеет канал до  PC1 и S2. S2 имеет канал до SRV2. R3 имеет канал до S3. S3 имеет канал до SRV1. Существует линия, которая рисует путь от R1 до выхода интерфейса R3s G0/0/0 с помощью команд show ip route и show ipv6 route.
-->
...
<!--
На рисунке показана топология и пример предотвращения атак спуфинга с помощью ACL. R1 связан с последовательным соединением с R2. R2 связан с последовательным соединением с R3. R1 имеет канал до S1. S1 имеет канал до  PC1 и S2. S2 имеет канал до SRV2. R3 имеет канал до S3. S3 имеет канал до SRV1. Для предотвращения атаки спуфингом адресов отклоняйте все пакеты с адресом источника 172.16.1.0/24, поступающие на последовательный интерфейс 0/1/1.
-->
...
<!-- 12.5.13 -->
## Packet Tracer. Поиск и устранение неполадок в корпоративных сетях
...
[Поиск и устранение неполадок в корпоративных сетях (pdf)](./assets/12.5.13-packet-tracer---troubleshoot-enterprise-networks.pdf)
