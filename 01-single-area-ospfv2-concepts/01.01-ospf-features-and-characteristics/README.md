...
**2. Обмен данными о состоянии каналов**

После установления соединения роутеры обмениваются данными о состоянии канала (LSA). LSA содержат информацию о состоянии и стоимости каждого канала с прямым подключением. Роутеры отправляют свои LSA смежным устройствам. При получении LSA смежные устройства мгновенно отправляют свои данные соседям с прямым подключением, и так до тех пор, пока все роутеры области не получат все LSA.
