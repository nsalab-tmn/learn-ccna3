...
<!--
На рисунке показаны объявления протокола Cisco Discovery Protocol (CDP), отправляемые между напрямую подключенными маршрутизатором и коммутатором. Стрелка, помеченная рекламой CDP, указывает от коммутатора на маршрутизатор, а другая стрелка указывает от маршрутизатора на коммутатор. Стрелки указывают на периодические рекламные объявления CDP, отправляемые между двумя устройствами.
-->
...
<!--
На рисунке показан маршрутизатор с надписью R1, подключенный к облаку с вопросительным знаком.
-->
...
<!--
На рисунке показан маршрутизатор с меткой R1, подключенный к коммутатору S1. S1 подключается к облаку, помеченному вопросительным знаком.
-->
...
[Создание карты сети с помощью протокола CDP (pdf)](./assets/10.1.5-packet-tracer---use-cdp-to-map-a-network.pdf)
