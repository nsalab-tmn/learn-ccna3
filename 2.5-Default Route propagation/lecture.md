...
[Распростанение маршрута по умолчанию в OSPFv2 (pdf)](./assets/2.5.3-packet-tracer---propagate-a-default-route-in-ospfv2_ru-RU.pdf)

[Распростанение маршрута по умолчанию в OSPFv2 (pka)](./assets/2.5.3-packet-tracer---propagate-a-default-route-in-ospfv2_ru-RU.pka)
