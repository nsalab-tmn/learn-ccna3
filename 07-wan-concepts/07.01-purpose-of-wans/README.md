...
Для подключения за пределами локальной сети требуется глобальная сеть (WAN). **WAN** — это телекоммуникационная сеть, которая охватывает относительно большой географический район. Глобальная сеть работает за пределами географической области LAN.
...
<!--
На рисунке показывана схема корпоративного кампуса с несколькими зданиями, роутерами, коммутаторами и сетями, подключенными к глобальной сети Интернет, которая затем подключается к различным удаленным сайтам и пользователям.
-->
...
<!--
На рисунке показано облако с роутером-концентратором на одной площадке, который подключается отдельно к трем роутерам: Spoke A, Spoke B и Spoke C через облако.
-->
...
<!--
На рисунке показана топология с двумя узлами, облако с двумя узловыми роутерами на одной площадке, каждый из которых подключается отдельно к трем оконечным роутерам: Spoke A, Spoke B и Spoke C через облако. 
-->
...
<!--
На рисунке показаны 4 роутера: сайт A, сайт B, сайт C и сайт D. Каждый из них подключается ко всем трем другим роутерам через облако.
-->
...
<!--
На рисунке показаны 4 роутера: сайт A, сайт B, сайт C и сайт D. Они подключаются к другим роутерам через облако, но не ко всем. 
-->
...
<!--
На рисунке показан роутер корпоративной площадки, подключающийся к роутеру ISP. 
-->
...
<!--
На рисунке показан роутер корпоративной площадки, подключенный отдельно к двум различным устройствам ISP.
-->
...
<!--
На рисунке показан небольшой офис, состоящий из беспроводного роутера, принтера, трех пользователей компьютера и модема с широкополосным доступом в Интернет.
-->
...
<!--
На рисунке показан многоэтажный дизайн бизнес-городка с несколькими роутерами, коммутаторами, точками беспроводного доступа и устройствами конечных точек, которые подключаются к Интернету через брандмауэр роутера.
-->
