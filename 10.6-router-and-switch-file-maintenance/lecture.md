...
<!--
На рисунке показан пример сохранения файлов конфигурации в текстовый файл Tera Term. В Tera Term во вкладке Log выбрать File. Во всплывающем окне задается вопрос о том, где сохранить файл, в примере используются Мои документы, имя файла, R1-Config и тип сохранения файла. Появилось другое окно, показывающее процесс передачи байтов, а также имя файла и fullpath.
-->
...
<!--
На рисунке показан пример копирования и вставки файлов конфигурации из текстового файла на устройство в Tera Term. В Tera Term в разделе File выбрать Send file. Во всплывающем окне запрашивается, какой файл отправлять, в примере выбирается текстовый файл R1-Config в разделе Мои документы. Появилось другое окно, показывающее процесс передачи байтов, а также имя файла, fullpath и прошедшее время.
-->
...
<!--
На рисунке показаны порты USB на задней панели маршрутизатора Cisco 4321. Порт управления USB и мини-порт USB типа B выделены прямоугольником.
-->
...
[Резервное копирование файлов конфигурации (pdf)](./assets/10.6.10-packet-tracer---back-up-configuration-files.pdf)
...
[Управление файлами конфигурации маршрутизатора с помощью программы Tera Term (lab)](./assets/10.6.11-lab---use-tera-term-to-manage-router-configuration-files.pdf)
...
[Управление файлами конфигурации устройств с использованием TFTP-сервера, флеш-памяти и USB-накопителя - режим симуляции физического оборудования (pdf)](./assets/10.6.12-packet-tracer---use-tftp-and-flash-to-manage-configuration-files---physical-mode.pdf)
...
[Управление файлами конфигурации устройств с использованием TFTP-сервера, флеш-памяти и USB-накопителя (lab)](./assets/10.6.12-lab---use-tftp--flash--and-usb-to-manage-configuration-files.pdf)
...
[Исследование и выполнение процедур восстановления пароля - режим симуляции физического оборудования (pdf)](./assets/10.6.13-packet-tracer---research-and-execute-password-recovery-procedures---physical-mode.pdf)
...
[Изучение процедур восстановления паролей (lab)](./assets/10.6.13-lab---research-password-recovery-procedures.pdf)
