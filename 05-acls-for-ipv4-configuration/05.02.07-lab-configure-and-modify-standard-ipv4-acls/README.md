...
Часть 1. Проверить связи

Часть 2. Настроить и проверить стандартные нумерованные списки ACL и стандартные именованные ACL-списки

Часть 3. Измененить стандартный ACL-список
