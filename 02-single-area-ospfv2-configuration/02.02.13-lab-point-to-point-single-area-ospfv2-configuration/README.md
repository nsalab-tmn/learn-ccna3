...
Часть 1. Настроить идентификаторы роутеров.

Часть 2. Настроить сети для маршрутизации OSPF.

Часть 3. Настроить пассивные интерфейсы.

Часть 4. Проверить конфигурацию OSPF.
