...
Перемещайте белый кружок по временной шкале на рисунке, чтобы просмотреть отношение сложности инструментов атак к техническим знаниям, необходимыми для их использования.
